...
<body>
	<div class="generic-banner">
		<div class="container" style="padding-top: 30px; padding-bottom: 15px;">
			<div class="row">
				<div class="col-md-5">
					<h2 class="text-white">Add New Address</h2>
				</div>
			</div>	
		</div>
	</div>
	...
	<div class="container" style="margin-top: 50px;">
		...
		<div class="col-md-10">
			...
			<div class="row" style="margin-bottom: 20px;">
				...
				<div class="col-md-3">
					<input type="" name="mob" value="+973 " class="form-control">
				</div>
				<div class="col-md-3">
					<h6 style="margin-top: 5px;">LandLine(Optional):</h6>
				</div>
				<div class="col-md-3">
					<input type="" name="landline" class="form-control">
				</div>
			</div>
			...
			<div class="row" style="margin-bottom: 20px;">
				...
				<div class="col-md-3">
					<input list="areas" name="area"  class="form-control">
					<datalist id="areas">
				...
				<div class="col-md-3">
					<input type="" name="blk" class="form-control" >
				</div>
			</div>
			...
			<div class="row" style="margin-bottom: 20px;">
				...
				<div class="col-md-3">
					<input type="" name="rd" class="form-control">
				</div>
			</div>
			...
			<div class="row" style="margin-bottom: 20px;">
				...
				<div class="col-md-3">
					<input type="" name="bldg" class="form-control">
				</div>
				<div class="col-md-3">
					<h6 style="margin-top: 5px;">Floor:</h6>
				</div>
				<div class="col-md-3">
					<input type="" name="flr" class="form-control">
				</div>
			</div>
			...
			<div class="row" style="margin-bottom: 50px;">
				...
				<div class="col-md-3">
					<input type="" name="apt" class="form-control">
				</div>
				<div class="col-md-3">
					<h6 style="margin-top: 5px;">Additional Directions:</h6>
				</div>
				<div class="col-md-3">
					<input type="" name="adir" class="form-control">
				</div>
			</div>
			...
			<div class="row" style="margin-bottom: 20px;">
				...
				<div class="col-md-4">
					...
					<input type="hidden" name="type" value="new-address">
