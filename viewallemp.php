...
?>
 ...
 <li class="menu-active"><a href="admininterface.php">Admin Homepage</a></li>
					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								<h2 class="text-white">List of All Restaurent Admin and Staff</h2>
								<p class="text-white">Below is The List of All Restaurent Admin and Staff</p>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="whole-wrap">
        ...
        <p> <center> <font size='4'> <b> List of Restaurent Admin and Staff </b> </font> </center> </p>
...
try{
  ...
  $sql = "SELECT * FROM users WHERE type ='staff' OR type ='admin'";
  $r=$db->prepare($sql);
  $r->execute();
?>
          ...
          while($row = $r -> fetch())
          {
            ...
            ?>
					<div class="table-row">
						...
						<div class="visit"> <?php echo $row[7]; ?> </div>
						<div class="serial"> </div>
            ...
            <div class="container border-top-generic">
              <h6 align='center' class="about-title mb-30">
                <div class="button-group-area mt-10">
                  ...
                  <a href="managestaff.php" class="genric-btn primary-border radius">Manage Employees Roles</a>
                  <a href="addnewemp.php" class="genric-btn primary-border radius">&nbsp &nbsp &nbsp &nbsp Add New Staff &nbsp &nbsp &nbsp &nbsp</a>
                  <a href="logout.php" class="genric-btn primary-border radius">Sign-out</a>
